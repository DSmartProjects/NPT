...
namespace VideoKallMCCST.Model
{
    public class PMMConfiguration: NotifyPropertyChanged
    {
        ...
        private string _testResultAPI_URL;
        public string TestResultAPI_URL { get { return _testResultAPI_URL; } set { _testResultAPI_URL = value; OnPropertyChanged("TestResultAPI_URL"); } }
